...
public class LearnStateFactoryMlp
        implements AccumulatorStateFactory<LearnState>
{
    ...
    private static final long MLP_PARAMETERS_SIZE = ClassLayout.parseClass(MlpParameter.class).instanceSize();
